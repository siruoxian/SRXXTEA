#
#  Be sure to run `pod spec lint SRXXTEA.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "siruoxian" => "siruoxian@sohu.com" }
  # Or just: s.author    = "siruoxian"
  # s.authors            = { "siruoxian" => "siruoxian@sohu.com" }
  # s.social_media_url   = "http://twitter.com/siruoxian"
  ...
  s.source       = { :git => "https://github.com/siruoxian/SRXXTEA.git", :tag => "#{s.version}" }
